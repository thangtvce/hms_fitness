      ...
      >
        ...
        <View style={styles.flameContainer}>
          ...
          <Animated.View style={[styles.raysSvgWrapper, { transform: [{ rotate: rayRotationDegrees }] }]}>
            ...
            >
              <Svg.Defs>
                <Svg.RadialGradient id="rayRadialGradient" cx="0" cy="0" r="100%" fx="0" fy="0">
                  {/* Gradient from opaque yellow at center to transparent at outer edge */}
                  <Svg.Stop offset="0%" stopColor="rgba(255, 200, 0, 0.8)" /> {/* Opaque at center */}
                  <Svg.Stop offset="100%" stopColor="rgba(255, 200, 0, 0)" /> {/* Transparent at outer edge */}
                </Svg.RadialGradient>
              </Svg.Defs>
              {renderRays()}
            </Svg.Svg>
