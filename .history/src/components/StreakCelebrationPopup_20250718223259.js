          ...
          <Svg width={center * 2} height={center * 2}>
            <Defs>
              <SVGGradient id={`grad-${i}`} x1="0" y1="0" x2="0" y2="1">
                ...
                <Stop offset="0%" stopColor="rgba(255,20,147,0.95)" />
                <Stop offset="20%" stopColor="rgba(255,20,147,0.7)" />
                <Stop offset="60%" stopColor="rgba(255,182,193,0.18)" />
                <Stop offset="100%" stopColor="rgba(255,240,245,0.01)" />
              </SVGGradient>
            </Defs>
            <Polygon 
              points={points} 
