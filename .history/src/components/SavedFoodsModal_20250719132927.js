        ...
        <View style={{ flex: 1, backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: 48, overflow: 'hidden' }}>
          ...
          <View style={{ flex: 1, paddingHorizontal: 20, paddingBottom: 20 }}>
            ...
            {editIdx !== null && (
              ...
              >
                <View style={{ flex: 1, backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, borderWidth: 1, borderColor: '#E5E7EB', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, elevation: 6, padding: 20, alignItems: 'center', justifyContent: 'flex-start' }}>
