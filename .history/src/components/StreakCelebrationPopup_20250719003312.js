...
const NUM_RAYS = 8 // Fewer rays, more spaced out
...
const StreakCelebrationPopup = ({ isVisible, streakCount, onClose }) => {
  ...
  const renderRays = () => {
    ...
    const rayWidth = 16
    const innerCircle = 90 // Rays start further from center for visible empty circle
...
const styles = StyleSheet.create({
  ...
  ray: {
    position: "absolute",
    backgroundColor: "rgba(255,215,0,0.55)", // More visible
    borderRadius: 8,
