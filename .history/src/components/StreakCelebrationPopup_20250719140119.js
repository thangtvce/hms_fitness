    ...
    >
      ...
      >
        ...
        <View style={styles.flameContainer}>
          ...
          <LottieView
            key={explosionKey}
            source={require('../../assets/animation/StreakFire.json')}
            autoPlay
            loop={false}
            style={{ position: 'absolute', width: 200, height: 200, top: '50%', left: '50%', marginLeft: -100, marginTop: -100, zIndex: 2, pointerEvents: 'box-none' }}
          />
          <Animated.View
            style={[
              styles.flameGif,
