  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Flame with Boom and Pixelburst effects behind */}
        <View style={styles.flameContainer}>
          {/* 7 small Pixelburst Lottie effects as background, arranged around the flame */}
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            autoPlay
            loop
            style={{
              position: 'absolute', width: 70, height: 70, top: '10%', left: '20%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 60, height: 60, top: '20%', left: '70%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 80, height: 80, top: '60%', left: '75%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 65, height: 65, top: '75%', left: '50%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 60, height: 60, top: '70%', left: '15%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 75, height: 75, top: '40%', left: '5%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          <LottieView
            source={require('../../assets/animation/Pixelburst.json')}
            ...
            loop
            style={{
              position: 'absolute', width: 90, height: 90, top: '15%', left: '45%', zIndex: 0, pointerEvents: 'box-none',
            }}
          />
          ...
          <LottieView
            ...
            autoPlay
            loop
            style={[StyleSheet.absoluteFill, { zIndex: 1, pointerEvents: 'box-none' }]}
          />
