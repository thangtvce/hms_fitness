    ...
    <View style={styles.container}>
      ...
      >
        <Svg width={SIZE} height={SIZE}>
          <Defs>
            <LinearGradient id="grad" x1="0.5" y1="0.15" x2="0.5" y2="1">
              <Stop offset="0%" stopColor="#FFB800" stopOpacity="1" />
              <Stop offset="40%" stopColor="#FFB800" stopOpacity="0.85" />
              <Stop offset="80%" stopColor="#FFB800" stopOpacity="0.25" />
