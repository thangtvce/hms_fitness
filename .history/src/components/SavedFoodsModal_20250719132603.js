          ...
          <View style={{ flex: 1, paddingHorizontal: 20, paddingBottom: 20 }}>
            {editIdx === null ? (
              ...
              <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: 32 }}>
                <View style={{ width: '100%', maxWidth: 340, backgroundColor: '#fff', borderRadius: 16, borderWidth: 1, borderColor: '#E5E7EB', padding: 20, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, elevation: 2 }}>
                  <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 6, textAlign: 'center', color: '#1E293B' }}>Chỉnh sửa khẩu phần</Text>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 8 }}>
                    <TouchableOpacity
                      ...
                      onPress={handleSave}
                    >
                      <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 16 }}>{editLoading ? 'Đang lưu...' : 'Lưu'}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                      <Text style={{ color: '#64748B', fontSize: 16, fontWeight: 'bold' }}>Hủy</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
