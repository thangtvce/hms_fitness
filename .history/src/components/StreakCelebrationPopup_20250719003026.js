...
const StreakCelebrationPopup = ({ isVisible, streakCount, onClose }) => {
  ...
  // Define per-ray gradient color stops (customize here)
  const rayGradients = [
    // 8 rays, you can set different colors for each
    [
      { offset: "0%", color: "rgba(255, 193, 7, 1)" },
      { offset: "10%", color: "rgba(255, 200, 40, 0.95)" },
      { offset: "20%", color: "rgba(255, 210, 60, 0.85)" },
      { offset: "30%", color: "rgba(255, 215, 70, 0.7)" },
      { offset: "40%", color: "rgba(255, 220, 80, 0.5)" },
      { offset: "50%", color: "rgba(255, 220, 80, 0.35)" },
      { offset: "60%", color: "rgba(255, 220, 80, 0.2)" },
      { offset: "70%", color: "rgba(255, 220, 80, 0.12)" },
      { offset: "80%", color: "rgba(255, 220, 80, 0.05)" },
      { offset: "90%", color: "rgba(255, 220, 80, 0.01)" },
      { offset: "100%", color: "rgba(255, 220, 80, 0)" },
    ],
    [
      { offset: "0%", color: "rgba(255, 140, 0, 1)" },
      { offset: "25%", color: "rgba(255, 220, 80, 0.85)" },
      { offset: "60%", color: "rgba(255, 220, 80, 0.25)" },
      { offset: "100%", color: "rgba(255, 220, 80, 0.01)" },
    ],
    [
            ...
            >
              <Defs>
                {Array.from({ length: NUM_RAYS }).map((_, i) => (
                  ...
                  >
                    {rayGradients[i % rayGradients.length].map((stop, idx) => (
