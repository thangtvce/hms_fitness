...
const styles = StyleSheet.create({
  container: {
    flexDirection: "row",
    alignItems: "center",
    height: 76, // Increased height for a taller header
    backgroundColor: "#fff",
    zIndex: 10,
    paddingTop: 10, // Add some top padding for better vertical centering
    paddingBottom: 10, // Add some bottom padding for better vertical centering
  },
  streakContainer: {
    flexDirection: "row",
    alignItems: "center",
