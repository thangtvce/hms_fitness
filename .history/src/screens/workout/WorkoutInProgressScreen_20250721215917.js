                    ...
                    <View style={styles.newModalContainer}>
                      ...
                      <View style={styles.newModalContent}>
                        ...
                        <View style={styles.modalMainContent}>
                          ...
                          {/* Nút Stop mới */}
                          <TouchableOpacity
                            style={[styles.modalTertiaryButton, { backgroundColor: '#ef4444', borderRadius: 12, marginTop: 10 }]}
                            onPress={() => {
                              setShowResumePopup(false);
                              completeWorkout();
                              navigation.goBack();
                          ...
                          >
                            <Text style={[styles.modalTertiaryButtonText, { color: '#fff', fontWeight: 'bold' }]}>Stop</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    </View>
