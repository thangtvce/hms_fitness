    ...
    >
      <View style={styles.exerciseCardHeader}>
        ...
        <View style={styles.exerciseCardInfo}>
          ...
          {/* Thông tin: sets, reps, notes; duration và rest cùng hàng riêng */}
          ...
          {/* Note ở cuối card, không tô đậm */}
        </View>
        {item.notes && (
          <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 2, marginLeft: 8, marginBottom: 2 }}>
            <Text style={{ fontSize: 13, color: '#888', marginRight: 4 }}>note:</Text>
