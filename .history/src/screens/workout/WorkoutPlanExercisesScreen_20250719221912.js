    ...
    >
      <View style={styles.exerciseCardHeader}>
        ...
        <View style={styles.exerciseCardInfo}>
          ...
          {/* Thông tin: sets, duration_minutes, reps, rest_time_seconds, notes */}
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', marginTop: 4 }}>
            ...
            {item.duration_minutes !== undefined && (
              <Text style={{ fontSize: 13, color: '#666', marginRight: 10 }}>duration: {item.duration_minutes}m</Text>
            )}
            {item.reps !== undefined && (
              <Text style={{ fontSize: 13, color: '#666', marginRight: 10 }}>reps: {item.reps}</Text>
            )}
            {item.rest_time_seconds !== undefined && (
              <Text style={{ fontSize: 13, color: '#666', marginRight: 10 }}>rest: {item.rest_time_seconds}s</Text>
            )}
            {item.notes && (
              <Text style={{ fontSize: 13, color: '#888', flexShrink: 1 }} numberOfLines={1}>
