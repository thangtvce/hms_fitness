                      ...
                      >
                        ...
                        <View style={styles.activityContent}>
                          ...
                          <Text style={styles.activityStats}>
                            {act.caloriesBurned} cal • {formatDuration(act.durationMinutes)}
                          </Text>
// Format duration in minutes:seconds or hours:minutes:seconds if needed
function formatDuration(duration) {
  // duration is in seconds or minutes? Check data. If usually in seconds, convert to mm:ss
  // If duration is over 90, assume seconds, else if over 60 and always integer, could be minutes
  // For safety, if duration < 100, treat as seconds, else treat as minutes
  let totalSeconds = 0;
