                    ...
                    <View style={styles.newModalContainer}>
                      ...
                      <View style={styles.newModalContent}>
                        ...
                        <View style={styles.modalMainContent}>
                          ...
                          {/* Chỉ hiển thị chữ Stop khi còn bài tập */}
                          {exercisesLeft > 0 && (
                            <View style={{ alignItems: 'center', marginBottom: 18 }}>
                              <Text style={{ color: '#ef4444', fontWeight: 'bold', fontSize: 20, marginBottom: 2 }}>Stop</Text>
                              <Text style={{ color: '#ef4444', fontWeight: '400', fontSize: 14, textAlign: 'center' }}>(Kết thúc buổi tập)</Text>
                            </View>
                          )}
