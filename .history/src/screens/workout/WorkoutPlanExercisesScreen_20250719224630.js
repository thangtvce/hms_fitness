  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        {loading ? (
          <View style={{ flex: 1, minHeight: 300, justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            <ShimmerPlaceholder style={{ height: 200, width: '90%', borderRadius: 16, marginBottom: 16 }} />
            <ShimmerPlaceholder style={{ height: 200, width: '90%', borderRadius: 16, marginBottom: 16 }} />
            <ShimmerPlaceholder style={{ height: 200, width: '90%', borderRadius: 16, marginBottom: 16 }} />
            <ShimmerPlaceholder style={{ height: 200, width: '90%', borderRadius: 16, marginBottom: 16 }} />
          </View>
