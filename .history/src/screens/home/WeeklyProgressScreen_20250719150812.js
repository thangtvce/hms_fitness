        ...
        >
          ...
          {loading ? (
            <View style={{ marginBottom: 16 }}>
              <ShimmerPlaceholder style={{ height: 220 }} />
            </View>
          ) : (
    ...
    return (
      <View style={{ flex: 1 }} {...(panResponder ? panResponder.panHandlers : {})}>
        ...
        >
          ...
          {loading ? (
            <>
              <ShimmerPlaceholder style={{ height: 220, marginBottom: 16 }} />
              <ShimmerPlaceholder style={{ height: 120 }} />
            </>
          ) : (
            <>
              {macrosData?.macros ? (
        ...
        >
          ...
          {loading ? (
            <>
              <ShimmerPlaceholder style={{ height: 220 }} />
              <ShimmerPlaceholder style={{ height: 120 }} />
              <ShimmerPlaceholder style={{ height: 180 }} />
            </>
          ) : (
            <>
              {/* Weight Chart */}
