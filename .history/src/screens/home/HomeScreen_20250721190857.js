...
export default function HomeScreen({ navigation }) {
  ...
  if (loading && !refreshing) {
    return (
      <>
        <ShimmerCard height={100} style={{ margin: 24, borderRadius: 16 }} />
        <ShimmerCard height={120} style={{ margin: 24, borderRadius: 16 }} />
        <ShimmerCard height={300} style={{ margin: 24, borderRadius: 16 }} />
      </>
    )
  }
