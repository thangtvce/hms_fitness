    ...
    () => [
      {
        ...
        icon: "moon",
        route: "SleepScreen", // Assuming a route for sleep
      },
      {
        title: "Recipes",
        subtitle: "Cook, eat, log, repeat",
        icon: "book-open", // Changed from 'list' to 'book-open' for recipes
        route: "RecipesScreen", // Assuming a route for recipes
      },
      {
        title: "Workouts",
        subtitle: "Sweating is self-care",
        icon: "dumbbell", // Changed from 'list' to 'dumbbell' for workouts
      ...
      },
      {
        ...
        icon: "users",
        route: "Community", // Reusing Community route for Friends
      },
      {
        title: "Community",
