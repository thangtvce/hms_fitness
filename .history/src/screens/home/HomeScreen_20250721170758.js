...
export default function HomeScreen({ navigation }) {
  ...
  const renderFoodImageItem = (food, idx) => (
    <TouchableOpacity key={food.foodId + '-' + idx} style={styles.foodCarouselItem} activeOpacity={0.8}>
          ...
          <>
            ...
            <Animated.View
              style={[
                ...
                { marginBottom: 80, marginTop: 30, opacity: fadeAnim, transform: [{ translateY: translateY }] },
              ]}
            >
...
const styles = StyleSheet.create({
  ...
  foodCarouselItem: {
    ...
    // Remove left margin for first item to allow overflow
    marginLeft: 0,
  },
  foodImage: {
