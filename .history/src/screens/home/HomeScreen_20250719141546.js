      ...
      <Header
        title={
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "flex-start", flex: 1 }}>
            ...
            {/* Avatar, Fire animation, and currentStreak on the left; HMS Fitness centered; right actions on the right */}
            <View style={{ flexDirection: "row", alignItems: "center", flex: 1, justifyContent: "space-between" }}>
              {/* Left: Avatar, Fire, Streak */}
              <View style={{ flexDirection: "row", alignItems: "center" }}>
         
                {/* Fire animation and streaak */}
              ...
              <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                <Text
                  style={{ fontSize: 20, fontWeight: "bold", color: colors.headerText || "#0056d2" }}
                >
                  HMS Fitness
                </Text>
              </View>
              {/* Right: (empty, rightActions handled by Header) */}
              <View style={{ width: 60 }} />
            </View>
          </View>
        }
        ...
        rightActions={[
          {
            ...
            label:
              dashboardData?.user?.currentStreak !== undefined ? `${dashboardData.user.currentStreak} 🔥` : undefined,
          },
          {
