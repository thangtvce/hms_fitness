      ...
      <Header
        title={
          <View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
            {/* Left: Fire animation and streak */}
            {dashboardData?.user?.currentStreak !== undefined && (
              <View style={{ flexDirection: "row", alignItems: "center", marginLeft: SPACING, marginRight: 8 }}>
                <LottieView
                  source={
                  ...
                  autoPlay
                  loop
                  style={{ width: 32, height: 32, marginLeft: 0, marginRight: 0 }}
                />
                <Text
                  style={{
                    fontSize: 18,
            ...
            {/* Center/Left: Current weekday name in English */}
            <Text style={{ fontSize: 18, fontWeight: "bold", color: colors.headerText || "#0056d2", marginLeft: 0, marginRight: 12 }}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background || "#F8FAFC" }]}>
      <Header
        title={
          <View style={{ flexDirection: "row", alignItems: "center", flex: 1 }}>
            {/* Left: Current weekday name in English */}
            <Text style={{ fontSize: 18, fontWeight: "bold", color: colors.headerText || "#0056d2", marginLeft: SPACING, marginRight: 12 }}>
              {new Date().toLocaleDateString("en-US", { weekday: "long" })}
            </Text>
            {/* Spacer to push streak to the right */}
            <View style={{ flex: 1 }} />
            {/* Right: Fire animation and streak, close to right actions */}
            {dashboardData?.user?.currentStreak !== undefined && (
