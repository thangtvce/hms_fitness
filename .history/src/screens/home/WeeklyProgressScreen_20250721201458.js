      ...
      {[
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            // Remove border highlight when selected
          ]}
    ...
    return (
      <View style={{ flex: 1 }} {...(panResponder ? panResponder.panHandlers : {})}>
        ...
        >
          ...
          />
          {loading ? (
            <ShimmerPlaceholder style={{ height: 320, marginBottom: 16 }} borderRadius={16} />
          ) : (
    ...
    return (
      <View style={{ flex: 1 }} {...(panResponder ? panResponder.panHandlers : {})}>
        ...
        >
          ...
          {loading ? (
            <>
              <ShimmerPlaceholder style={{ height: 220, marginBottom: 16 }} borderRadius={16} />
              <ShimmerPlaceholder style={{ height: 100 }} borderRadius={16} />
            </>
          ) : (
            <>
              {macrosData?.macros ? (
    ...
    return (
      <View style={{ flex: 1 }} {...(panResponder ? panResponder.panHandlers : {})}>
        ...
        >
          ...
          {loading ? (
            <>
              <ShimmerPlaceholder style={{ height: 260, marginBottom: 16 }} borderRadius={16} />
              <ShimmerPlaceholder style={{ height: 180, marginBottom: 16 }} borderRadius={16} />
              <ShimmerPlaceholder style={{ height: 180 }} borderRadius={16} />
            </>
          ) : (
            <>
              {/* Weight Chart */}
