...
export default function HomeScreen({ navigation }) {
  ...
  if (loading && !refreshing) {
    return (
      <View style={{ marginTop: 50, paddingHorizontal: 16, width: '100%' }}>
        <ShimmerCard height={100} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={100} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={300} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={400} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={300} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={100} style={{ marginVertical: 12, borderRadius: 16 }} />
        <ShimmerCard height={300} style={{ marginVertical: 12, borderRadius: 16 }} />
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background || "#F8FAFC" }]}>
      ...
      >
        {/* Always render main sections, use fallback if dashboardData is missing */}
