            ...
            renderItem={({ item, index }) => (
              <View style={[styles.historyItem, index === 0 && styles.historyItemFirst]}>
                ...
                <View style={styles.historyItemRight}>
                  <Text style={[styles.historyNutrient, { color: NUTRIENT_COLORS.carbs }]}>Carbs: {Number(item.carbs).toFixed(1)}</Text>
                  <Text style={[styles.historyNutrient, { color: NUTRIENT_COLORS.protein }]}>Protein: {Number(item.protein).toFixed(1)}</Text>
                  <Text style={[styles.historyNutrient, { color: NUTRIENT_COLORS.fats }]}>Fats: {Number(item.fats).toFixed(1)}</Text>
                </View>
              </View>
            )}
            ListEmptyComponent={
