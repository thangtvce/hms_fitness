  ...
  return (
    <View style={styles.container}>
      <Header
        ...
        rightActions={[
          {
            icon: savedFoods.length > 0 || badgeLoading ? (
              <View style={{
                minWidth: 36,
                height: 36,
                borderRadius: 18,
                ...
                {badgeLoading ? (
                  <LottieView
                    ...
                    autoPlay
                    loop
                    style={{ width: 36, height: 36, position: 'absolute', left: 0, top: 0 }}
                  />
                ) : (
                  <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>{savedFoods.length}</Text>
                )}
              </View>
            ) : null,
            onPress: async () => {
              ...
              <View style={{ position: 'relative', width: 32, height: 32 }}>
                ...
                {isAnimating && (
                  <LottieView
                    ...
                    autoPlay
                    loop={false}
                    style={{ width: 80, height: 80, position: 'absolute', left: -24, top: -24, zIndex: 3 }}
                  />
                )}
              </View>
            </View>
