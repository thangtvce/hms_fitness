  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.imageContainerNew}>
        <Image source={{ uri: food.image }} style={styles.heroImageNew} resizeMode="cover" />
      ...
      <ScrollView style={styles.contentContainerNew} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.nutritionGridNew}>
...
const styles = StyleSheet.create({
  ...
  nutritionGridNew: {
    ...
    borderRadius: 12, // Slight border radius for the whole grid
