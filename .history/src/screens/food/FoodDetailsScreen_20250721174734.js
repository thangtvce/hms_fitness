  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={styles.imageOverlayButtons}>
        ...
        <TouchableOpacity style={styles.overlayButton} onPress={toggleFavorite}>
          <MaterialIcons
        ...
        <ScrollView style={[styles.contentContainerNew, { marginTop: 280 }]} showsVerticalScrollIndicator={false}>
          <View style={styles.titleContainer}>
            <View style={styles.titleLeft}>
              <Text style={styles.categoryLabel} numberOfLines={1} ellipsizeMode="tail">{food.categoryName}</Text>
          ...
          <View style={styles.bottomBarContent}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
              <TouchableOpacity style={styles.addToCartButton} onPress={handleAddFoodToMeal}>
                <View style={[styles.gradientButton, { backgroundColor: "#0056d2", flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 10 }]}> 
                  <MaterialIcons name="add-shopping-cart" size={20} color="#FFFFFF" style={styles.buttonIcon} />
                  <Text style={[styles.buttonText, { color: "#fff", fontSize: 16, marginLeft: 4 }]}>Add</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity style={{ marginLeft: 0, padding: 0 }} onPress={toggleFavorite}>
                <MaterialIcons
                  name={isFavorite ? "favorite" : "favorite-border"}
                  size={24}
                  color={isFavorite ? "#EF4444" : "#6B7280"}
