      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={{ alignItems: "center", marginTop: 40 }}>
            <Ionicons name="fast-food-outline" size={48} color={colors.textSecondary || "#64748B"} style={{ marginBottom: 12 }} />
            <Text style={{ color: colors.textSecondary || "#64748B", fontSize: 16, fontWeight: "600", marginBottom: 4 }}>
              No recommended foods yet
            </Text>
            <Text style={{ color: colors.textSecondary || "#64748B", fontSize: 13, textAlign: "center" }}>
              There is no data to display. Please log your meals or update your profile to get personalized recommendations.
            </Text>
          </View>
        }
      />
