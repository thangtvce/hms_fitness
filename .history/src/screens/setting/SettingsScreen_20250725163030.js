...
const menuItemsCommon = [
  ...
  { id: "reviewed", title: "Reviewed Packages", icon: "star", description: "View your reviewed packages" },
  ...
  const handleMenuItemPress = (item) => {
    switch (item.title) {
      case "Need to Review":
        ...
        break;
      case "Reviewed Packages":
        navigation.navigate("SubscriptionReviewedScreen");
        break;
      case "Profile":
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView
        ...
        onScroll={({ nativeEvent }) => {
          ...
          // If user is within 40px of the bottom, consider at bottom
