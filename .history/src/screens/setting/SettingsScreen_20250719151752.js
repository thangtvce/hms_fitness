      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#fff", padding: 20 }}>
          <View style={{ width: "90%", maxWidth: 400 }}>
            {/* Profile Card */}
            <ShimmerPlaceholder style={{ height: 120, borderRadius: 16, marginBottom: 24 }} />
            {/* Premium Button */}
            <ShimmerPlaceholder style={{ height: 60, borderRadius: 14, marginBottom: 24 }} />
            {/* Menu List (simulate 6 items) */}
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: 44, borderRadius: 12, marginBottom: 24 }} />
            {/* App Version */}
            <ShimmerPlaceholder style={{ height: 20, borderRadius: 8, marginBottom: 0 }} />
          </View>
        </View>
      </SafeAreaView>
    )
