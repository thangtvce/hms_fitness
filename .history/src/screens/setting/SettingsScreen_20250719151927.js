  ...
  if (loading && !refreshing) {
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#fff", padding: 20 }}>
            <View style={{ width: "90%", maxWidth: 400 }}>
              ...
              {/* Measure Premium Button */}
              <TouchableOpacity style={[styles.premiumButton, { opacity: 0, position: 'absolute', left: 0, top: 0, width: '100%' }]} onLayout={e => setPremiumHeight(e.nativeEvent.layout.height)}>
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#fff", padding: 20 }}>
          <View style={{ width: "90%", maxWidth: 400 }}>
            <ShimmerPlaceholder style={{ height: profileCardHeight, borderRadius: 16, marginBottom: 24 }} />
            <ShimmerPlaceholder style={{ height: premiumHeight, borderRadius: 14, marginBottom: 24 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 12 }} />
            <ShimmerPlaceholder style={{ height: menuItemHeight, borderRadius: 12, marginBottom: 24 }} />
            <ShimmerPlaceholder style={{ height: versionHeight, borderRadius: 8, marginBottom: 0 }} />
          </View>
        </View>
      </SafeAreaView>
    );
