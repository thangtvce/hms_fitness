  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.safeArea}>
        ...
        {/* Shimmer cho SearchBar */}
        <View style={{ backgroundColor: '#fff', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#E2E8F0' }}>
          <ShimmerPlaceholder style={{ height: 40, borderRadius: 12 }} />
        </View>
        <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          {/* Shimmer cho Tabs */}
          <View style={{ backgroundColor: '#fff', marginTop: 8, paddingBottom: 16 }}>
            <View style={{ flexDirection: 'row', gap: 12, paddingHorizontal: 20, marginTop: 16, marginBottom: 16 }}>
              <ShimmerPlaceholder style={{ flex: 1, height: 36, borderRadius: 8 }} />
              <ShimmerPlaceholder style={{ flex: 1, height: 36, borderRadius: 8 }} />
              <ShimmerPlaceholder style={{ flex: 1, height: 36, borderRadius: 8 }} />
            </View>
            {/* Shimmer cho Statistics */}
            <View style={{ flexDirection: 'row', gap: 12, marginHorizontal: 16, marginBottom: 16 }}>
              <ShimmerPlaceholder style={{ flex: 1, height: 70, borderRadius: 12 }} />
              <ShimmerPlaceholder style={{ flex: 1, height: 70, borderRadius: 12 }} />
              <ShimmerPlaceholder style={{ flex: 1, height: 70, borderRadius: 12 }} />
            </View>
            {/* Shimmer cho Chart */}
            <View style={{ marginHorizontal: 16 }}>
              <ShimmerPlaceholder style={{ height: 220, borderRadius: 16, marginBottom: 24 }} />
            </View>
          </View>
          ...
          <View style={{ backgroundColor: '#fff', marginTop: 8, paddingBottom: 16 }}>
            <View style={{ marginHorizontal: 16, marginTop: 16 }}>
              {[...Array(4)].map((_, idx) => (
                <ShimmerPlaceholder key={idx} style={{ height: 60, borderRadius: 16, marginBottom: 12 }} />
              ))}
            </View>
          </View>
        </ScrollView>
...
const renderStatistics = () => (
  ...
  const renderChart = () => (
    <View style={styles.chartSection}>
      ...
      {/* Filter Tabs */}
      <View style={[styles.filterTabs, { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 }]}> 
        {CHART_FILTERS.map((filter, idx) => (
          <TouchableOpacity
            key={filter.id}
            style={[
              styles.filterTab,
              { 
                borderRadius: 6, // giảm bo góc
                borderTopLeftRadius: idx === 0 ? 6 : 0,
                borderBottomLeftRadius: idx === 0 ? 6 : 0,
                borderTopRightRadius: idx === CHART_FILTERS.length - 1 ? 6 : 0,
                borderBottomRightRadius: idx === CHART_FILTERS.length - 1 ? 6 : 0,
                marginLeft: idx === 0 ? 0 : -1, // nối liền
                flex: 1, // trải rộng đều
              },
              mainFilter === filter.id && styles.filterTabActive
            ]}
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.safeArea}>
        {/* Shimmer cho Header */}
        <ShimmerPlaceholder style={{height: 40, borderRadius: 8, marginBottom: 24, marginTop: 20, marginHorizontal: 16}} />
        {/* Shimmer cho Search Bar */}
        <ShimmerPlaceholder style={{height: 40, borderRadius: 12, marginBottom: 16, marginHorizontal: 16}} />
        {/* Shimmer cho Tabs */}
        <View style={{flexDirection: 'row', gap: 12, marginBottom: 24, marginHorizontal: 20}}>
          <ShimmerPlaceholder style={{flex: 1, height: 36, borderRadius: 8}} />
          <ShimmerPlaceholder style={{flex: 1, height: 36, borderRadius: 8}} />
          <ShimmerPlaceholder style={{flex: 1, height: 36, borderRadius: 8}} />
        </View>
        ...
        {/* Shimmer cho Chart */}
        <ShimmerPlaceholder style={{height: 240, borderRadius: 16, marginBottom: 24, marginHorizontal: 16}} />
        {/* Shimmer cho Logs List */}
        <ShimmerPlaceholder style={{height: 260, borderRadius: 16, marginHorizontal: 16}} />
      </SafeAreaView>
    );
  }
