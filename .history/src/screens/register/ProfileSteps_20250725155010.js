        ...
        {loadingSteps.map((step, index) => (
          <View
            ...
            style={[
              styles.loadingStep,
              {
                backgroundColor: index === currentStep ? "#E3F2FD" : "#F3F4F6",
                opacity: index <= currentStep ? 1 : 0.5,
              },
            ]}
          >
            <View style={styles.loadingStepContent}>
              <Text style={styles.loadingStepIcon}>{index < currentStep ? "✓" : index === currentStep ? "⏳" : "•"}</Text>
...
const styles = StyleSheet.create({
  // ... (keep your existing styles here, and add the fixedButtonContainer below)
