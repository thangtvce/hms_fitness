...
import { View, Text, TouchableOpacity, StyleSheet, Dimensions, ScrollView, TextInput, Image } from "react-native"
  ...
  return (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.promoImageContainer}>
        <Image
          source={{
            uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-HGZ0sK2SkV4loRHJKCGSL5o9DHdHU0.png",
          }}
  ...
  return (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.promoImageContainer}>
        <Image
          source={{
            uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-0Hx5py0YYY1OeYaBVkC49Gl85Oceva.png",
          }}
          style={styles.promoImage}
          resizeMode="cover"
        />
  ...
  return (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.bodyFatCard}>
        <View style={styles.bodyFatInputSection}>
        ...
        <View style={styles.bodyFatRanges}>
          <Text style={styles.rangesTitle}>Typical Body Fat Ranges:</Text>
          <View style={styles.rangeItem}>
            <View style={styles.rangeDot} />
            <Text style={styles.rangeText}>Essential: 3-5% (men), 10-13% (women)</Text>
          </View>
          <View style={styles.rangeItem}>
            <View style={styles.rangeDot} />
            <Text style={styles.rangeText}>Athletes: 6-13% (men), 14-20% (women)</Text>
          </View>
          <View style={styles.rangeItem}>
            <View style={styles.rangeDot} />
            <Text style={styles.rangeText}>Fitness: 14-17% (men), 21-24% (women)</Text>
          </View>
          <View style={styles.rangeItem}>
            <View style={styles.rangeDot} />
            <Text style={styles.rangeText}>Average: 18-24% (men), 25-31% (women)</Text>
          </View>
        </View>
      </View>
      ...
      <TouchableOpacity
        style={[styles.nextButton, (!bodyFat || bodyFat.trim() === "") && styles.disabledButton]}
          ...
          {loadingSteps.map((step, index) => (
            ...
            >
              <View style={styles.loadingStepContent}>
                <View
                  style={[
                    styles.loadingStepIconContainer,
                    { backgroundColor: index <= currentStep ? "#0056d2" : "#E5E7EB" },
                  ]}
                >
                  {index <= currentStep ? (
                    <Text style={styles.loadingStepCheckmark}>✓</Text>
                  ) : (
                    <View style={styles.loadingStepDot} />
                  )}
                </View>
                <Text style={[styles.loadingStepText, { color: index <= currentStep ? "#1F2937" : "#9CA3AF" }]}>
                  {step}
                </Text>
              </View>
            </View>
        ...
        <View style={styles.metricsGrid}>
          ...
          <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
              ...
              <Text style={styles.metricTitle}>Daily Calories</Text>
            </View>
            <Text style={styles.metricValue}>{getCalorieRange(calorieGoal || 1500)}</Text>
            <Text style={styles.metricUnit}>kcal per day</Text>
          </View>
          ...
          {bmi && (
            <View style={styles.metricCard}>
              ...
              <Text style={[styles.metricUnit, { color: bmiInfo.color }]}>{bmiInfo.category}</Text>
            </View>
          )}
          ...
          <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
              ...
              <Text style={styles.metricTitle}>Activity Level</Text>
            </View>
            <Text style={styles.metricValue}>{formData?.activityLevel || "Moderate"}</Text>
            <Text style={styles.metricUnit}>Current level</Text>
          </View>
          ...
          <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
              ...
              <Text style={styles.metricTitle}>Primary Goal</Text>
            </View>
            <Text style={styles.metricValue}>{formData?.fitnessGoal || "Maintain"}</Text>
            <Text style={styles.metricUnit}>Focus area</Text>
          </View>
        </View>

        <TouchableOpacity style={styles.startJourneyButton} onPress={onStart}>
          <Text style={styles.startJourneyButtonText}>START MY HEALTH JOURNEY</Text>
          <Text style={styles.startJourneyButtonArrow}>→</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
...
const styles = StyleSheet.create({
  ...
  stepContainer: {
    ...
    alignItems: "center",
    paddingVertical: 20,
    minHeight: screenDimensions.height - 200,
  },
  progressBar: {
    width: "100%",
    height: 6,
  ...
  // Body Fat Step Styles - Redesigned
  bodyFatCard: {
  ...
  // Loading Screen Styles - Redesigned
  loadingContainer: {
    flex: 1,
    backgroundColor: "#FFFFFF",
  },
  ...
  // Recommendations Screen Styles - Redesigned
  ...
  recommendationsContent: {
    ...
    paddingTop: 32,
    paddingBottom: 40,
    minHeight: screenDimensions.height * 0.55,
  },
  metricsGrid: {
    marginBottom: 32,
  },
