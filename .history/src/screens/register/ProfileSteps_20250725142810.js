...
export default function ProfileSteps({
  ...
  const handleStartApp = async () => {
    ...
    // Use reset to go to HomeScreen (main tab) after profile completion
    navigation.reset({
      index: 0,
      routes: [
        { name: 'Main', params: { screen: 'HomeScreen' } }
      ],
    });
// Example: TouchableOpacity to switch tab to HomeScreen (like login button)
// <TouchableOpacity style={styles.loginButton} onPress={() => navigation.replace('Main', { screen: 'HomeScreen' })}>
//   <Text style={styles.loginText}>Go to Home Tab</Text>
// </TouchableOpacity>
  }
