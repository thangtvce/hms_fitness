...
export default function ProfileSteps({
  ...
  const goNext = () => {
    console.log("[goNext] called, step:", step, formData);
    ...
    if (step < 8) {
      ...
      console.log("[goNext] calling handleCompleteProfile");
...
const BodyFatStep = ({ formData, handleChange, error, onComplete }) => {
  ...
  const handleComplete = () => {
    ...
    if (typeof onComplete === "function") {
      ...
      console.log("[BodyFatStep] onComplete is not a function", onComplete);
    }
  };
