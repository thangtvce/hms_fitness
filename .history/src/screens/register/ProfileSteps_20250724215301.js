      ...
      try {
        ...
        if (err.response && err.response.data.data) {
          if (err.response.data.data.message) {
            showErrorFetchAPI("[UpdateUser] " + err.response.data.data.message);
          } else if (err.response.data..dataerrors) {
            showErrorFetchAPI("[UpdateUser] " + JSON.stringify(err.response.data.data.errors));
          } else {
            showErrorFetchAPI("[UpdateUser] " + JSON.stringify(err.response.data.data));
          }
        } else if (err.message) {
