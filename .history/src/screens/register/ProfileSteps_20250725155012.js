...
export default function ProfileSteps({
  ...
  // Tách phần renderStep thành 2 phần: phần nội dung (không có nút) và phần nút cố định
  const stepContent = renderStep(true); // truyền true để chỉ render nội dung, không render nút
  const stepButton = renderStep(false); // truyền false để chỉ render nút
...
// Age Step
const AgeStep = ({ formData, handleChange, error, onContinue, onlyContent }) => {
  ...
  // Nếu onlyContent=true thì chỉ render phần nội dung, không render nút
  // Nếu onlyContent=false thì chỉ render nút
  if (onlyContent) {
    return (
...
// Gender Step
const GenderStep = ({ formData, handleSelect, error, onContinue, onlyContent }) => {
...
// Height Step
const HeightStep = ({ formData, handleChange, handleSelect, error, onContinue, onlyContent }) => {
...
// Weight Step
const WeightStep = ({ formData, handleChange, handleSelect, error, onContinue, onlyContent }) => {
...
// Activity Level Step
const ActivityLevelStep = ({ formData, handleSelect, error, onContinue, onlyContent }) => {
...
// Fitness Goal Step
const FitnessGoalStep = ({ formData, handleSelect, error, onContinue, onlyContent }) => {
...
// Goals Step
const GoalsStep = ({ formData, handleToggle, error, onContinue, onlyContent }) => {
  const goalsOptions = [
...
const DietaryPreferenceStep = ({ formData, handleSelect, error, onContinue, onlyContent }) => {
...
// Body Fat Step
const BodyFatStep = ({ formData, handleChange, error, onComplete, onlyContent }) => {
        ...
        {loadingSteps.map((step, index) => (
          <View
            ...
            style={[
              styles.loadingStep,
              {
  // renderStep(onlyContent: true) => chỉ render nội dung, false => chỉ render nút
  const renderStep = (onlyContent) => {
    switch (step) {
      case 0:
        return <AgeStep formData={formData} handleChange={handleChange} error={validationErrors.age} onContinue={goNext} onlyContent={onlyContent} />
      case 1:
        return <GenderStep formData={formData} handleSelect={handleSelect} error={validationErrors.gender} onContinue={goNext} onlyContent={onlyContent} />
      case 2:
        return <HeightStep formData={formData} handleChange={handleChange} handleSelect={handleSelect} error={validationErrors.height} onContinue={goNext} onlyContent={onlyContent} />
      case 3:
        return <WeightStep formData={formData} handleChange={handleChange} handleSelect={handleSelect} error={validationErrors.weight} onContinue={goNext} onlyContent={onlyContent} />
      case 4:
        return <ActivityLevelStep formData={formData} handleSelect={handleSelect} error={validationErrors.activityLevel} onContinue={goNext} onlyContent={onlyContent} />
      case 5:
        return <FitnessGoalStep formData={formData} handleSelect={handleSelect} error={validationErrors.fitnessGoal} onContinue={goNext} onlyContent={onlyContent} />
      case 6:
        return <GoalsStep formData={formData} handleToggle={handleToggle} error={validationErrors.goals} onContinue={goNext} onlyContent={onlyContent} />
      case 7:
        return <DietaryPreferenceStep formData={formData} handleSelect={handleSelect} error={validationErrors.dietaryPreference} onContinue={goNext} onlyContent={onlyContent} />
      case 8:
        return <BodyFatStep formData={formData} handleChange={handleChange} error={validationErrors.bodyFatPercentage} onComplete={goNext} onlyContent={onlyContent} />
      default:
        return null;
    }
  }
// Thêm style cho nút cố định dưới cùng
