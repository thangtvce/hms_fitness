...
const { user,loading: authLoading } = useAuth();
  ...
  // Xác định initialRouteName phù hợp
  let initialRoute = 'AppIntroScreen';
  if (user && profileCheck.needProfile) {
    initialRoute = 'ProfileSteps';
  } else if (user) {
    initialRoute = 'Main';
  }
  return (
    <>
      ...
      >
        {/* Luôn có các màn hình đầy đủ, nhưng nếu user cần hoàn thành profile thì chỉ cho phép truy cập ProfileSteps, Login, RegisterScreen */}
        ...
        {/* Các màn hình còn lại chỉ cho phép nếu user đã có profile */}
        {!user || !profileCheck.needProfile ? <>
  ...
  console.log('DEBUG profileCheck:', profileCheck);
    ...
    <>
      ...
      >
        ...
        {!user || !profileCheck.needProfile ? <>
          ...
          <Stack.Screen name="QRPaymentScreen" component={QRPaymentScreen} options={{ gestureEnabled: false, headerShown: false }} />
          <Stack.Screen name="PaymentSuccessScreen" component={PaymentSuccessScreen} options={{ gestureEnabled: false, headerShown: false }} />
          <Stack.Screen name="PaymentCancelled" component={PaymentCancelledScreen} options={{ gestureEnabled: false, headerShown: false }} />
