import SubscriptionReviewDetailScreen from 'screens/subscription/SubscriptionReviewDetailScreen';
...
import SubscriptionReviewedScreen from '../screens/subscription/SubscriptionReviewedScreen';
...
import CreatePostFromScreenshotScreen from 'screens/community/CreatePostFromScreenshotScreen';
...
import PaymentErrorScreen from 'screens/servicePackage/PaymentErrorScreen';
...
import BodyMeasurementAnalystScreen from 'screens/profile/bodymeasurement/BodyMeasurementAnalystScreen';
import TrainerWorkoutPlanDetailScreen from 'screens/trainer/workoutPlan/TrainerWorkoutPlanDetailScreen';
import SupportScreen from 'screens/support/SupportScreen';
import EditServicePackageScreen from 'screens/trainer/service/EditServicePackageScreen';
import RecipesScreen from 'screens/food/RecipesScreen';
function RootNavigator() {
  ...
  useEffect(() => {
    const checkProfileState = async () => {
      ...
      if (!user) {
        setInitialRoute('AppIntroScreen');
        return;
      }
      try {
        const profileFormData = await AsyncStorage.getItem('profileFormData');
        const profileCurrentStep = await AsyncStorage.getItem('profileCurrentStep');
        if (profileFormData || profileCurrentStep) {
          setInitialRoute('ProfileSteps');
        } else {
  ...
  return (
    <>
      <IncomingCallNotification incomingCall={incomingCall} setIncomingCall={setIncomingCall} setAcceptedCallRoomId={setAcceptedCallRoomId} />
      <Stack.Navigator
        initialRouteName={initialRoute}
        screenOptions={{ headerShown: false }}
      >
        <Stack.Screen name="AppIntroScreen" component={AppIntroScreen} />
        <Stack.Screen name="ProfileSteps" component={ProfileSteps} />
        ...
        <Stack.Screen name="BodyMeasurementAnalyst" component={BodyMeasurementAnalystScreen} />
        ...
        <Stack.Screen name="CaloriesLogStatisticsScreen" component={CaloriesLogStatisticsScreen} options={{ title: 'Statistic calories' }} />
        ...
        <Stack.Screen name="EditServicePackage" component={EditServicePackageScreen} />
        ...
        <Stack.Screen name="PaymentErrorScreen" component={PaymentErrorScreen} options={{
          gestureEnabled: false,
          headerShown: false
        }} />
        ...
        <Stack.Screen name="SubscriptionDetail" component={SubscriptionDetailScreen} options={{
          gestureEnabled: false
        }} />
        ...
        <Stack.Screen name="CreatePostFromScreenshotScreen" component={CreatePostFromScreenshotScreen} />
        ...
        <Stack.Screen name="SubscriptionReviewDetailScreen" component={SubscriptionReviewDetailScreen} options={{ title: 'Chi tiết đánh giá gói tập' }} />
        <Stack.Screen name="SubscriptionReviewedScreen" component={SubscriptionReviewedScreen} options={{ title: 'Đã đánh giá' }} />
        ...
        <Stack.Screen name="TrainerWorkoutPlanDetailScreen" component={TrainerWorkoutPlanDetailScreen} options={{ title: 'Trainer workout management' }} />
        <Stack.Screen name="AddExerciseToPlanScreen" component={AddExerciseToPlanScreen} options={{ title: 'Trainer workout plan detail exercise management' }} />
        ...
        <Stack.Screen name="SubscriptionReviewScreen" component={SubscriptionReviewScreen} options={{ title: 'Đánh giá gói tập' }} />
