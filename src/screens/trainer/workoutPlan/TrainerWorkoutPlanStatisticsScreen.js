...
const TrainerWorkoutPlanStatisticsScreen = () => {
    ...
    useEffect(() => {
        ...
        const fetchStatistics = async () => {
            try {
                ...
                const response = await trainerService.getWorkoutPlanStatistic(user.userId,params);
                if (response.statusCode === 200 && response.data) {
                    setStatistics(response.data);
                    startAnimations();
                } else {
                    showErrorFetchAPI(new Error('Workout plan statistics not found.'));
                    setStatistics(null);
                }
            } catch (error) {
    ...
    const renderLoadingScreen = () => (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.loadingContainer}>
                ...
                <Text style={styles.loadingText}>Loading workout plan statistics...</Text>
            </View>
        </SafeAreaView>
    );
        ...
        >
            ...
            <Text style={styles.emptyText}>
                {filters.startDate || filters.endDate || filters.status !== 'all'
                    ...
                    : 'No workout plan statistics found.'}
            </Text>
            {(filters.startDate || filters.endDate || filters.status !== 'all') && (
                <TouchableOpacity
            ...
            <View style={styles.fieldContainer}>
                ...
                <View style={styles.statsGrid}>
                    <View style={styles.statCard}>
                        <Text style={styles.statCardLabel}>Total Plans</Text>
                        <Text style={styles.statCardValue}>{statistics?.totalPlans || 0}</Text>
                    </View>
                    {statistics?.planWithMostExercises && (
                        <View style={styles.statCard}>
                            <Text style={styles.statCardLabel}>Plan with Most Exercises</Text>
                            <Text style={styles.statCardValue}>
                                {statistics.planWithMostExercises.planName} ({statistics.planWithMostExercises.exerciseCount} exercises)
                            </Text>
                        </View>
                    )}
                </View>
    ...
    const renderStatusChart = () => {
        const pieData = statistics?.plansByStatus?.map((item) => ({
                ...
                <View style={styles.fieldContainer}>
                    <View style={styles.fieldHeader}>
                        <View style={styles.fieldLabelContainer}>
                            ...
                            <Text style={styles.fieldLabel}>Plans by Status</Text>
                        </View>
                    </View>
    ...
    const renderDateChart = () => {
        const barData = {
            labels: statistics?.plansByCreationDate?.map((item) => `${item.month}/${item.year % 100}`) || [],
            datasets: [
                {
                    data: statistics?.plansByCreationDate?.map((item) => item.count) || [],
                },
            ],
        };
                ...
                <View style={styles.fieldContainer}>
                    <View style={styles.fieldHeader}>
                        <View style={styles.fieldLabelContainer}>
                            ...
                            <Text style={styles.fieldLabel}>Plans by Creation Date</Text>
                        </View>
                    </View>
                    <View style={styles.chartContainer}>
                        <BarChart
                        ...
                        <View style={styles.filterSection}>
                            ...
                            <View style={styles.statusOptions}>
                                {[
                                    ...
                                    { key: 'active',label: 'Active',icon: 'pulse',color: '#22C55E' },
                                    { key: 'inactive',label: 'Inactive',icon: 'close-circle-outline',color: '#F59E0B' },
                                ].map((status) => (
                                    <TouchableOpacity
                                        key={status.key}
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.headerContent}>
                    <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('TrainerWorkoutPlanManagement')}>
                        <Ionicons name="arrow-back" size={24} color="#0056D2" />
                    </TouchableOpacity>
                    <View style={styles.headerCenter}>
                        <Text style={styles.headerTitle}>Workout Plan Statistics</Text>
                    </View>
...
export default TrainerWorkoutPlanStatisticsScreen;