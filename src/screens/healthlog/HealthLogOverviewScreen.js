...
export default function HealthLogOverviewScreen() {
      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          .human-body svg:not(#chest):not(#head) path { 
            fill: #64B5F6; 
            opacity: 0.85;
          }
          ...
          <>
            <View style={styles.metricCard}>
              ...
              >
                ...
                <Text style={styles.metricValue}>{Math.round(stats.averageHeartRate)}</Text>
            ...
            <View style={styles.metricCard}>
              <LinearGradient
                ...
                style={styles.metricGradient}
              >
                <MaterialCommunityIcons name="lungs" size={28} color="#FFFFFF" />
                <Text style={styles.metricValue}>{Math.round(stats.averageBloodOxygenLevel)}</Text>
            ...
            <View style={styles.metricCard}>
              ...
              >
                ...
                <Text style={styles.metricValue}>{stats.averageSleepDuration}</Text>
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={["#F8FAFC", "#E2E8F0", "#CBD5E1"]} style={styles.backgroundGradient}>
          ...
          >
            <View style={styles.headerContent}>
              ...
              <View style={styles.headerCenter}>
                ...
                <Text style={styles.headerSubtitle}>Interactive 3D Body Analytics</Text>
              </View>
